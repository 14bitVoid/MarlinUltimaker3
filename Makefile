...
CXXSRC = WMath.cpp WString.cpp Print.cpp Marlin_main.cpp	\
	MarlinSerial.cpp motion_control.cpp planner.cpp		\
	stepper.cpp temperature.cpp flow.cpp \
	watchdog.cpp cap_sense_probe.cpp temperaturePID.cpp \
        PowerBudgetManagement.cpp PowerBudgetManagementBed.cpp  PowerBudgetManagementHotendSlot.cpp
CXXSRC += i2c_capacitance_FDC1004.cpp i2c_driver.cpp pca9635_driver.cpp \
	fan_driver.cpp temperature_ADS101X.cpp led_rgbw_pca9632.cpp flow_AS5048B.cpp \
    i2c_onewire_ds2482.cpp oneWireDS2431_eeprom.cpp
...
CXXFLAGS :=         $(CDEFS) $(CINCS) -O$(OPT) -Wall -Wextra $(CEXTRA) $(CTUNING)
